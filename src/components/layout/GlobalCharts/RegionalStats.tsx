  ...
  return (
    <div className="flex flex-col rounded-xl bg-gray-50 p-5 dark:bg-gray-700/50">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-800 dark:text-white">
            ...
            <span className="flex items-center gap-1.5">
              <span className="text-xl font-emoji leading-none" role="img" aria-label={getCountryName(stats.country)}>
        ...
        {topResultInfo && (
          <div className={`rounded-full px-2 py-0.5 text-xs font-medium ${topResultInfo.bgColor} ${topResultInfo.color}`}>
