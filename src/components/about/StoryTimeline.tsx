  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-background/95 border-border/50 grid w-full max-w-5xl items-center gap-6 rounded-2xl border p-6 shadow-2xl backdrop-blur-xl md:grid-cols-2 md:gap-12 md:rounded-3xl md:p-8"
      >
        <div className="order-2 space-y-4 md:order-1 md:space-y-6">
          <motion.h3
            ...
            className="from-primary bg-linear-to-r to-purple-600 bg-clip-text text-3xl font-bold text-transparent md:text-5xl lg:text-6xl"
          >
            {item.title}
          </motion.h3>
          <motion.div
        ...
        <motion.div
          ...
          className="bg-muted/50 border-border relative order-1 flex aspect-video w-full items-center justify-center overflow-hidden rounded-xl border shadow-inner md:order-2 md:aspect-4/3 md:rounded-2xl"
        >
          <Image
            src={item.img}
            alt={item.title}
