/**
 * OpenGraph Image for API Documentation Page
 * Auto-generated OG image for /api-docs route
 */
...
export const alt = 'FLAMES API Documentation - Developer Guide';
export const size = OG_IMAGE_SIZES.default;
export const contentType = 'image/png';

export default async function Image() {
  const config = PAGE_OG_CONFIGS['api-docs'];
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: '48px', color: '#64748b', fontFamily: 'monospace' }}>{'{'}</span>
          <span style={{ fontSize: '32px', color: '#a855f7', fontFamily: 'monospace' }}>FLAMES</span>
          <span style={{ fontSize: '48px', color: '#64748b', fontFamily: 'monospace' }}>{'}'}</span>
        </div>
