...
const PolicySection = ({ icon, title, children, index, color }: PolicySectionProps) => {
...
const FlamesLetterBadge = ({ letter, meaning, color }: { letter: string; meaning: string; color: string }) => (
  <motion.div
