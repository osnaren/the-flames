/**
 * OpenGraph Image for About Page
 * Auto-generated OG image for /about route
 */
...
export const alt = 'About FLAMES Game - The Story Behind the Classic Game';
...
export default async function Image() {
  const config = PAGE_OG_CONFIGS.about;
