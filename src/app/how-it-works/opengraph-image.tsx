/**
 * OpenGraph Image for How It Works Page
 * Auto-generated OG image for /how-it-works route
 */
...
export const alt = 'How FLAMES Game Works - Step by Step Guide';
...
export default async function Image() {
  const config = PAGE_OG_CONFIGS['how-it-works'];
