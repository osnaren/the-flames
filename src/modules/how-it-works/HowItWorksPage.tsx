...
import { DEMO_COMMON_LETTERS, DEMO_NAME1, DEMO_NAME2, DEMO_REMAINING_COUNT } from './constants';
...
function HowItWorksPage() {
  ...
  return (
    <div className="from-surface/50 to-surface-container/30 min-h-screen bg-linear-to-b">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              <Step3FlamesSimulation remainingCount={DEMO_REMAINING_COUNT} />
            </motion.div>
