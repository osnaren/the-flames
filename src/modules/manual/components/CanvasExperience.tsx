        ...
        >
          ...
          >
            ...
            >
              <div className="space-y-8 sm:space-y-12">
                ...
                >
                  <div className="mb-4 flex items-center justify-center sm:mb-6">
                    <div className="bg-primary-container text-on-primary-container mr-3 flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-sm font-bold sm:mr-4 sm:h-8 sm:w-8 sm:text-lg">
                      1
                    </div>
                ...
                >
                  <div className="mb-4 flex items-center justify-center sm:mb-6">
                    <div className="bg-tertiary-container text-on-tertiary-container mr-3 flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-sm font-bold sm:mr-4 sm:h-8 sm:w-8 sm:text-lg">
                      2
                    </div>
                    <h2 className="text-on-surface truncate text-lg font-bold sm:text-2xl md:text-3xl">
                      {name2.toUpperCase()}
              ...
              >
                <div className="mb-4 flex items-center justify-center sm:mb-6">
                  <div className="bg-secondary-container text-on-secondary-container mr-3 flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-sm font-bold sm:mr-4 sm:h-8 sm:w-8 sm:text-lg">
                    3
                  </div>
